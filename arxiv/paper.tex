...
\documentclass[pra,singlecolumn,superscriptaddress,twoside,pra]{revtex4}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.8\columnwidth]{configMZI}
...
\begin{subfigure}{.5\columnwidth}
  \centering
  \includegraphics[width=.65\columnwidth]{fusion}
  \caption{}
  \label{fig:fusion}
\end{subfigure}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.4\columnwidth]{MZ}	
...
\begin{subfigure}{0.5\columnwidth}
  \centering
  \includegraphics[width=0.75\columnwidth]{MORDOR}
  \caption{}
  \label{fig:MORDOR}
\end{subfigure}
