...
crucial in the race to achieve quantum supremacy. \sihui{Quantum key distribution (QKD) fundamentally does not require interferometry, but sound QKD protocols using Mach-Zehnder interferometer have been proposed \cite{bib:Sasaki14}, and in some cases realized \cite{bib:Takesue15}.}
