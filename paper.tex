...
Technical advancements in linear optics have been made on many fronts that make it increasingly attractive for quantum computing applications. It is possible now to put single-photon sources and detectors together with linear-optical networks on a silica chip. The advantage of using such integrated photonics over bulk optics is that it is more stable against phase fluctuations, and miniaturized. This increases the scalability of optical implementations of quantum information protocols. Having all components on chip reduces coupling losses

In combination with the relative ease of transferring quantum states of light through fiber cables, it forms a powerful combination between quantum communication and quantum information processing on-chip.

Spontaneous parametric down-conversion (SPDC), a nonlinear optical process, has been the workhorse for providing entanglement in quantum states of light. Through SPDC, indistinguishable single-photon pairs have been a run-of-the-mill process for a few decades, but faced scalability issues as it is a probabilistic process.


There are several proposals for building
...
quantum computing. Cat states are states of the form, where is a weak coherent state. The logical qubits are determined by the sign of the relative phase Ralph et al., 2003. Gottesman, Kitaev, and
...
possible using quantum optics Gottesman et al., 2001.
...
representation of this formalism Lloyd and Braunstein,
1999. For a review article on optical quantum informa-
tion processing with continuous variables, see
...
ties to induce a single-photon controlled-NOT operation.
However, naturally occurring nonlinearities of this sort
are many orders of magnitude too small for our purposes. An alternative way to induce an effective interaction between photons is to make projective measurements with photodetectors. The difficulty with this
...
number of modes see also Sec. I.D. In 2001, Knill, Laflamme, and Milburn
2001


KLM constructed a
...
for linear optical quantum computing (LOQC) in Sec. V.
...
e.g., Nielsen and Chuang 2000. In Sec. VI we conclude
...
ferometers, and circuits, and define the different versions of the optical qubit.
...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.7\columnwidth]{reck}
