...
In this review we will focus on single-photon encoding. Although other encodings, particularly those using continuous variable states of light exist, single-photon encodings seem to be the most promising. In the last decade, single photons have been produced mainly through spontaneous parametric down-conversion (SPDC), a nonlinear optical process. SPDC produces single photons in correlated pairs that has been the workhorse for providing entanglement in quantum states of light. Through much development in production schemes, and improvement in crystal quality, the number of high quality indistinguishable photons that can be concurrently produced have increased steadily over the years. Single-photon pairs are now run-of-the-mill business for quantum optical labs, and in the last five years, three photons are the landmark. The current record for single photons stand at ten. We have also seen the meteoric rise of quantum dots for this purpose. The latter has the advantage of on-demand single photon production, while SPDC is an inherently probabilistic process.
