...
\end{align}
in the second quantization representation. This is the notation adopted by the community working in quantum metrology (see Section \ref{subsec:metrology}).
