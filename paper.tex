...
bib:237403,bib:Sweeney14}. An architecture that embeds the quantum dot in a micropillar cavity uses a resonant effect to achieve higher production efficiency€ and better photon purity \cite{bib:Ding16,bib:213601}. Using a time-bin loop-based architecture \cite{bib:Motes14} on a stream of such photons, quantum interference was demonstrated between five indistinguishable photons \cite{bib:WangHe16}.
...
\begin{subfigure}{.5\columnwidth}
  \centering
  \includegraphics[width=.6\columnwidth]{cluster_state}
  \caption{}
  \label{fig:cluster}
\end{subfigure}%
\begin{subfigure}{.5\columnwidth}
  \centering
  \includegraphics[width=.8\columnwidth]{fusion}
  \caption{}
  \label{fig:fusion}
\end{subfigure}
...
\subsection{Time-bins}\label{sec:timebins}
...
\begin{subfigure}{.5\columnwidth}
  \centering
  \includegraphics[width=0.9\columnwidth]{full_architecture}
  \caption{}
  \label{fig:FL_arch}
\end{subfigure}%
\begin{subfigure}{0.5\columnwidth}
  \centering
  \includegraphics[width=\columnwidth]{PBS_TB}
  \caption{}
  \label{fig:fusion}
\end{subfigure}
