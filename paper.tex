...
\end{align}
in the second quantization representation, \sihui{and the basis is the same as that for eq.~(\ref{eq:dualrail})}. This notation is commonly used in quantum metrological applications.
...
\begin{enumerate}
	...
	\item Photon-added or photon-subtracted squeezed vacuum states.
...
Linear optical interferometry has become a leading contender for the implementation of quantum information processing protocols. The preparation, manipulation and measurement of photonic quantum information \sihui{is already} mainstream and widely employed, with impressive experimental accuracies.
