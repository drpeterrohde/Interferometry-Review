%% This is file `revip-template.tex',
%% 
...
%% Stylefile to load REVIP template
\usepackage{revip}
...
Additionally load the package \verb+revip.sty+ in the preamble using
